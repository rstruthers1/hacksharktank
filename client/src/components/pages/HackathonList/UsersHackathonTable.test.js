...
describe('UsersHackathonTable', () => {
    ...
    it('should render correctly', () => {
        ...
        const tree = renderer.create(<Router location={history.location} navigator={history}><UsersHackathonTable hackathons={mockHackathons} /></Router>).toJSON();
    ...
    it('renders without crashing', () => {
        const history = createMemoryHistory();
        render(<Router location={history.location} navigator={history}><UsersHackathonTable hackathons={mockHackathons} /></Router>);
    });
    ...
    it('renders table with correct number of columns', () => {
        ...
        render(<Router location={history.location} navigator={history}><UsersHackathonTable hackathons={mockHackathons} /></Router>);
        const tableRows = screen.getAllByRole('row');
        expect(tableRows[0].children.length).toBe(6);
    });
    ...
    it('renders table with correct column headers', () => {
        ...
        expect(tableHeaders[5].innerHTML).toBe('Your Roles');
    });
